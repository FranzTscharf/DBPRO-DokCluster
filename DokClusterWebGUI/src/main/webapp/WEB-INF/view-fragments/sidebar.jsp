...
<div class="scroll-sidebar">
    ...
    <nav class="sidebar-nav">
        <ul id="sidebarnav">
            ...
            <li> <a class="waves-effect waves-dark" href="./metadata" aria-expanded="false"><i class="mdi mdi-cube-outline"></i><span class="hide-menu">Meta Data Carrot</span></a></li>
            <li> <a class="waves-effect waves-dark" href="./visualisations" aria-expanded="false"><i class="mdi mdi-elevation-rise"></i><span class="hide-menu">Kibana Visualisations</span></a></li>
