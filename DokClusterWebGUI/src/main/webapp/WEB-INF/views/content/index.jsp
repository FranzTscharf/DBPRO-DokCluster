                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><span class="lstick">
                                </span>Published Yearly</h4>
                                <iframe class="kibana-visualization" src="http://tscharf.ddnss.de:5601/app/kibana#/visualize/edit/ca898b50-fa32-11e7-ad19-fd7a4617d863?embed=true&_g=()&_a=(filters:!(),linked:!f,query:(query_string:(query:'*')),uiState:(vis:(legendOpen:!f)),vis:(aggs:!((enabled:!t,id:'1',params:(),schema:metric,type:count),(enabled:!t,id:'2',params:(customInterval:'2h',extended_bounds:(),field:issued,interval:y,min_doc_count:1),schema:segment,type:date_histogram)),listeners:(),params:(addLegend:!t,addTimeMarker:!f,addTooltip:!t,categoryAxes:!((id:CategoryAxis-1,labels:(show:!t,truncate:100),position:bottom,scale:(type:linear),show:!t,style:(),title:(text:'issued+per+year'),type:category)),grid:(categoryLines:!f,style:(color:%23eee)),legendPosition:bottom,seriesParams:!((data:(id:'1',label:Count),drawLinesBetweenPoints:!t,mode:stacked,show:true,showCircles:!t,type:histogram,valueAxis:ValueAxis-1)),times:!(),valueAxes:!((id:ValueAxis-1,labels:(filter:!f,rotate:0,show:!t,truncate:100),name:LeftAxis-1,position:left,scale:(mode:normal,type:linear),show:!t,style:(),title:(text:Count),type:value))),title:'Published+Yearly',type:histogram))" frameBorder="0" style="height: 350px; width: 100%; position: relative;"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
