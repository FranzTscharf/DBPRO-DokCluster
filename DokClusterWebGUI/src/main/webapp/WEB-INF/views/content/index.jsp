                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <iframe id="kibanaOverviewiFrame" src="http://localhost:5601/app/kibana#/visualize/edit/592b1030-f886-11e7-b4ca-3f2a7b9f7c37?embed=true&_g=()" frameBorder="0" style="height: 350px; width: 100%; position: relative;"></iframe>
                                <script>
                                    $(document).ready(function(){
                                    $('#kibanaOverviewiFrame').load(function(){
